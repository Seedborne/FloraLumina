...
func _on_plot_10_button_pressed():
...
func unlock_plot():
	...
	is_unlocked = true
	unlock_sound.play()
	$Plot10Button.texture_normal = load("res://art/openlock.png")
	$Plot10Button.texture_hover = load("res://art/hoveropenlock.png")
	$Plot10Unlock.hide()
	$Plot10Button.show()

func _on_plot_10_no_pressed():
	$Plot10Unlock.hide()
	$Plot10Button.show()

func _on_plot_10ok_pressed():
	$Plot10LowFunds.hide()
	$Plot10Button.show()
